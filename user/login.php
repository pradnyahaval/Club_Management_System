    ...
    <form action="/action_page.php" method="post">
        <div class="container">
            <div class="imgcontainer">
              ...
              <div class="container">
                <label for="u_mail"><b>Email</b></label>
                <input type="email" placeholder="Enter college mail" id="u_mail" name="u_mail" required>
            
                <label for="u_password"><b>Password</b></label>
                <input type="password" placeholder="Enter Password" id="u_password" name="u_password" required>
...
if(isset($_POST['u_login'])) {
    ...
    $sql=mysqli_query($conn, "SELECT * FROM user where email= '".$a_mail."' AND password='".$a_password."'");  //gives $sql true or false
    ...
    if($count == 1){  
        ...
        $_SESSIOn['position']=$resultRow[7];
        if($_SESSION['position']=='head')
          header('Location: ../user/club_authority/userhome.php');
        else if($_SESSION['position']=='member')
        header('Location: ../user/club_members/userhome.php');
    }  
    else{  
